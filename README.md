...
## Установка. Релиз 2026.2

### Windows
Для Windows x64 скачайте "свежий" (Latest) релиз [Setup_ResUst_vXXXX.X_Win.exe](https://github.com/electronik779/ResUst/releases) и установите, выбрав опцию "для всех пользователей".

>[!NOTE]
>Для работы программы требуются установленные на компьютере пакеты .NET SDK 10 и App SDK (версией 1.8). При отсутствии этих пакетов программа установки предложит скачать их и установить.
>
>В случае каких либо ошибок необходимо самостоятельно скачать и установить [.NET SDK 10](https://dotnet.microsoft.com/ru-ru/download/dotnet/10.0) и [App SDK](https://learn.microsoft.com/ru-ru/windows/apps/windows-app-sdk/downloads-archive) (проверено с версией 1.8.10). После их установки рекомендуется перезагрузить компьютер.

### MacOS
Для MacOS скачайте "свежий" (Latest) релиз Setup_WRST_vXXXX.X_Mac.dmg и установите.

>[!NOTE]
>Возможность установки и работоспособность не проверялись.

## Установка. Релиз 2026.1 - только Windows

Установка не требуется. Для Windows x64 скачайте "свежий" релиз [Windows-x64-ResUst.zip](https://github.com/electronik779/ResUst/releases), распакуйте в любую удобную для вас папку и запустите исполняемый файл (Reser.exe).
...
<img width="802" height="623" alt="image" src="https://github.com/user-attachments/assets/a876452e-0bf3-4370-b30d-604edb2ed377" />
