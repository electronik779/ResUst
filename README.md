...
Установка не требуется. Для Windows x64 скачайте "свежий" релиз [Windows-x64-ResUst.zip](https://github.com/electronik779/ResUst/releases), распакуйте в любую удобную для вас папку и запустите исполняемый файл (ResUst.exe).
